...
- TRM Labs, *2026 Crypto Crime Report* — February 2026 snarkjs Groth16 exploit class
...
if (actual !== EXPECTED_SHA256) { console.error("ptau integrity FAILED"); process.exit(1); }
```
...
*End of Report — Project Worldline Security Audit v1.0*
*Commit in scope: `0204d5354f5d58d2b32a6ceb5c25b46f33efe82f`*
