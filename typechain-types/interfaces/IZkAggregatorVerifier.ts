...
export interface IZkAggregatorVerifier extends BaseContract {
  connect(runner?: ContractRunner | null): IZkAggregatorVerifier;
  waitForDeployment(): Promise<this>;

  interface: IZkAggregatorVerifierInterface;
