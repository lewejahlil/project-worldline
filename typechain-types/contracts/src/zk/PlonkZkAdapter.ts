...
export interface PlonkZkAdapterInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "PROD_PROOF_MIN_LEN"
      | "expectedProofLength"
...
export interface PlonkZkAdapter extends BaseContract {
  connect(runner?: ContractRunner | null): PlonkZkAdapter;
  waitForDeployment(): Promise<this>;

  interface: PlonkZkAdapterInterface;
