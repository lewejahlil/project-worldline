...
export interface WorldlineFinalizerV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "MIN_ADAPTER_DELAY"
...
export interface WorldlineFinalizerV2 extends BaseContract {
  connect(runner?: ContractRunner | null): WorldlineFinalizerV2;
  waitForDeployment(): Promise<this>;

  interface: WorldlineFinalizerV2Interface;
